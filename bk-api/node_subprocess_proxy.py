    ...
    def _wrap(self, cmd):
        return [
            ...
            *self.extra_args,
            ...
            "IdentitiesOnly=true",
            "-o",
            f"ProxyCommand=ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no {self.proxy_user}@{self.proxy_host} -p {self.proxy_port} -i {self.proxy_key} netcat -U /home_dirs/node-{self.node_id.upper()}/rtun.sock",
